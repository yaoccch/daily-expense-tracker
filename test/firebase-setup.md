...
The app UI calls each monthly document an expense book. Create a book with the month picker, such as `June 2026`, then select that book before saving expenses.
